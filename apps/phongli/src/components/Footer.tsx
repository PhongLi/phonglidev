  ...
  return (
    <div className={clsx('max-w-[348px]')}>
      ...
      <p className={clsx('mb-4 font-normal leading-relaxed')}>
        I&apos;m PhongLi, a <strong>front-end developer</strong> who dreams to
        create value for others via software products
      </p>
      <ul className={clsx('-ml-2 flex gap-1')}>
        <li>
          <a
            href="https://www.linkedin.com/in/phonglidev/"
            target="_blank"
            rel="noreferrer nofollow"
          ...
          >
            <LinkedlnIcon className={clsx('h-5 w-5')} />
          </a>
        </li>
        <li>
          <a
      ...
      <div className={clsx('content-wrapper')}>
        ...
        >
          <div className={clsx('font-semibold')}>
            &copy; {dayjs().format('YYYY')}, PhongLi
          </div>
