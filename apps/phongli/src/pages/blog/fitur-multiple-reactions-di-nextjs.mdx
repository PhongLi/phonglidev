...
- `sessionId`
  ...
  Atau kalau mau inspect langsung juga gasss [kesini](https://github.com/PhongLi/enji.dev/blob/425e3c09c906c005a7e1d9efbf21b87906ffd443/apps/enji.dev/src/helpers/server.ts).
...
Bingung ya? hehe maaf, coba cek [full kodenya](https://github.com/PhongLi/enji.dev/blob/425e3c09c906c005a7e1d9efbf21b87906ffd443/apps/enji.dev/src/components/EmojiReaction.tsx).
